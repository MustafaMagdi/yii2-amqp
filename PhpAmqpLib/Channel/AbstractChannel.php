...
namespace iviu96afa\amqp\PhpAmqpLib\Channel;

use iviu96afa\amqp\PhpAmqpLib\Connection\AbstractConnection;
...
use iviu96afa\amqp\PhpAmqpLib\Helper\Protocol\Protocol080;
use iviu96afa\amqp\PhpAmqpLib\Helper\Protocol\Protocol091;
use iviu96afa\amqp\PhpAmqpLib\Helper\Protocol\Wait080;
use iviu96afa\amqp\PhpAmqpLib\Helper\Protocol\Wait091;
use iviu96afa\amqp\PhpAmqpLib\Helper\Protocol\MethodMap080;
use iviu96afa\amqp\PhpAmqpLib\Helper\Protocol\MethodMap091;
...
class AbstractChannel
{
    ...
    public function __construct(AbstractConnection $connection, $channel_id)
    {
        ...
        case '0.9.1':
            self::$PROTOCOL_CONSTANTS_CLASS = 'iviu96afa\amqp\PhpAmqpLib\Wire\Constants091';
